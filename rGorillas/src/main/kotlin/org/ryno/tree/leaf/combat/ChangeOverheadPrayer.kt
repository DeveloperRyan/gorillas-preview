...
class ChangeOverheadPrayer(script: Script) : Leaf<Script>(script, "Change Overhead Prayer") {
    override fun execute() {
        val correctPrayer = CombatUtils.getCorrectOverheadPrayer(State.gorillaAttackStyle) ?: return
